...
echo
echo "-- Testing backup/checking on MongoDB 3.2"
...
echo
echo "-- Restore backup on MongoDB 3.2"
...
echo
echo "-- Testing Replica Set Cluster on MongoDB 3.2"
...
echo
echo "-- Testing Sharded Cluster on MongoDB 3.2"
echo
echo "-- Create shards"
...
echo
echo "-- Testing Sharded Cluster with Replica set on MongoDB 3.2"
echo
